...
public class InsideMessage extends AppCompatActivity {
    ...
    void delegatedToSendMessage(){
        ...
        messageObject messageObject=new messageObject(FirebaseAuth.getInstance().getCurrentUser().getEmail(),name.toLowerCase(Locale),message_content,currentDateTime);
